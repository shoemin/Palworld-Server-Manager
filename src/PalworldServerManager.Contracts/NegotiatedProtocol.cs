...
public sealed class NegotiatedProtocol
{
    ...
    public static bool IsKnown(FeatureCapability value) => value is FeatureCapability.ServerInventory or FeatureCapability.ServerIdentity or FeatureCapability.LocalPrincipalSecurity;
}
