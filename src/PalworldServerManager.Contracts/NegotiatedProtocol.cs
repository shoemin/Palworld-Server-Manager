...
public sealed class NegotiatedProtocol
{
    ...
    public static bool IsKnown(FeatureCapability value) => value is FeatureCapability.ServerInventory or FeatureCapability.ServerIdentity or FeatureCapability.LocalPrincipalSecurity or FeatureCapability.PeerTrustActivation or FeatureCapability.PeerPairing or FeatureCapability.PeerRotationStatus or FeatureCapability.PeerRotationProposal or FeatureCapability.PeerRotationReceipt or FeatureCapability.PeerPairingAdvertisedInvitation or FeatureCapability.LocalOwnerPairing or FeatureCapability.LocalOwnerPeerActivation or FeatureCapability.PeerCurrentCredentialConfirmation or FeatureCapability.OperationActivity or FeatureCapability.PeerUnpair or FeatureCapability.PeerRecoveryCompletion or FeatureCapability.PeerRecoveryCompletionOffer;
}
