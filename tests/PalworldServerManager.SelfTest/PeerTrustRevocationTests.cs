...
internal static partial class PeerTrustRevocationTests
{
    ...
    private sealed class Rig:IDisposable
    {
        ...
        {
            var tables=new[]{"HostIdentity","SecureCredentialReferences","LocalPrincipals","TrustedManagers","PeerRelationshipIncarnations","TrustedManagerPairings","PeerLocalBindingEvidence","PendingCredentialReplacements","HostCapabilityGrants","ServerCapabilityGrants","AuthorizationRevision","AuditEvents"};
