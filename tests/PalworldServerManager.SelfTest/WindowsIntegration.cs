    ...
    private static async Task Suite(string? pairingProviderPath, string? pairingProviderHash)
    {
        ...
        try
        {
            ...
            if (protectedProvider is not null)
            {
                ...
                Console.WriteLine("PASS integration: actual native responder termination preserves asymmetric PeerBound, denies activation and repairs through fresh pairing");
